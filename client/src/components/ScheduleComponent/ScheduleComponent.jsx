...
const SchedulePage = () => {
    ...
    useEffect(() => {
        const loadInitialData = async () => {
            try {
                setLoadingData({ lectures: true, groups: true });
                ...
                setLoadingData({ lectures: false, groups: false });
            }
        };
            ...
            <Card
                ...
                extra={
                    <Button 
                        ...
                        icon={<PlusOutlined />}
                        onClick={() => showModal()}
                        disabled={loadingData.lectures || loadingData.groups}
                    >
                        Добавить занятие
                    </Button>
                }
            >
                <div className="filters" style={{ marginBottom: 16 }}>
                    ...
                    <Select
                        ...
                        allowClear
                        loading={loadingData.groups}
                        disabled={loading || loadingData.groups}
                    >
                        {groups.map(group => (
                            ...
                            <Form form={form} layout="vertical">
                                ...
                                >
                                    <Select 
                                        ...
                                        loading={loadingData.lectures}
                                        disabled={loadingData.lectures}
                                    >
