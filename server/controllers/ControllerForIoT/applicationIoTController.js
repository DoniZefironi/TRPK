...
class ApplicationIoTController {
    ...
    async createApplication(req, res, next) {
        try {
            ...
            const newApplication = await InternshipApplicationIoT.create({
                contacts,
                application_date,
                application_status,
                resume_link,
    ...
    async getApplications(req, res, next) {
        try {
            const applications = await InternshipApplicationIoT.findAll();
    ...
    async getApplicationById(req, res, next) {
        try {
            const { id } = req.params;
            const application = await InternshipApplicationIoT.findByPk(id);
    ...
    async deleteApplication(req, res, next) {
        try {
            ...
            const deleted = await InternshipApplicationIoT.destroy({ where: { application_id: id } });
...
module.exports = new ApplicationIoTController();