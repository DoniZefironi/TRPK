...
class ForumSectionIoTController {
    ...
    async createForumSection(req, res, next) {
        try {
            ...
            const newForumSection = await ForumSectionIoT.create({
                subsections,
                topic_subsections,
                moderators,
                id_user,
    ...
    async getForumSections(req, res, next) {
        try {
            const forumSections = await ForumSectionIoT.findAll();
    ...
    async getForumSectionById(req, res, next) {
        try {
            const { id } = req.params;
            const forumSection = await ForumSectionIoT.findByPk(id);
...
module.exports = new ForumSectionIoTController();