...
class RatingIoTController {
    ...
    async createRating(req, res, next) {
        try {
            ...
            const newRating = await UserRatingIoT.create({
                score,
                period,
                id_user
            });
    ...
    async getRatings(req, res, next) {
        try {
            const ratings = await UserRatingIoT.findAll();
    ...
    async getRatingById(req, res, next) {
        try {
            const { id } = req.params;
            const rating = await UserRatingIoT.findByPk(id);
    ...
    async deleteRating(req, res, next) {
        try {
            ...
            const deleted = await UserRatingIoT.destroy({ where: { id } });
...
module.exports = new RatingIoTController();