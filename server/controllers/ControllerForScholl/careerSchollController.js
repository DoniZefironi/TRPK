const { CareerGuidanceScholl } = require('../../models/models'); 
const ApiError = require('../../error/ApiError');

class CareerSchollController {
    ...
    async createCareerGuidance(req, res, next) {
        try {
            ...
            const newCareerGuidance = await CareerGuidanceScholl.create({
    ...
    async getCareerGuidances(req, res, next) {
        try {
            const careerGuidances = await CareerGuidanceScholl.findAll();
    ...
    async getCareerGuidanceById(req, res, next) {
        try {
            const { id } = req.params;
            const careerGuidance = await CareerGuidanceScholl.findByPk(id);
    ...
    async deleteCareerGuidance(req, res, next) {
        try {
            const { id } = req.params;
            const deleted = await CareerGuidanceScholl.destroy({ where: { id } });
...
module.exports = new CareerSchollController();